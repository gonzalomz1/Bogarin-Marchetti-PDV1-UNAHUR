...
const LISTA_RECURSOS = [
    ...
    {nombre: "JSON_JUGADOR_FLACO_SALTANDO", url: "./assets/personaje/personaje_flaco/personaje_flaco_saltando/JSON_JUGADOR_FLACO_SALTANDO.json"},
    {nombre: "JSON_GOLPE", url: "./assets/personaje/golpe/JSON_GOLPE.json"},
    {nombre: "JSON_NIVEL_UNO_PLATAFORMA_BASE", url: "./assets/nivelUno/JSON_NIVEL_UNO_PLATAFORMA_BASE.json"},
    {nombre: "JSON_NIVEL_UNO_PLATAFORMA_FLOTANTE", url: "./assets/nivelUno/JSON_NIVEL_UNO_PLATAFORMA_FLOTANTE.json"},
    {nombre: "JSON_ENEM_HAMBUR", url: "./assets/enemigos/JSON_ENEM_HAMBUR.json"},
